...
public class HumanSensorServer {//ラズパイ側に置いて、前もって実行させておく
    public static void main(String args[]) {//args[0]:ポート番号        
        try {
            int port = Integer.parseInt("8888");//args[0]); //サーバ側の待受ポート番号
            ...
            while(true) {
                ...
                System.out.println("/sys/class/gpio/gpio"+req+"/value");
